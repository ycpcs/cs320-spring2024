...
Tuesday, 4-2-24, by Noon for 50% extra credit (Marmoset)<br>Thursday, 4-4-24, by Noon for 25% extra credit (Marmoset)<br>Saturday, 4-6-24, by Noon for full credit (Marmoset) | [Lab 6: ORM](lab06.html) | [CS320\_Lab06.zip](CS320_Lab06.zip)
...
The exception to the above policy is that you may use ChatGPT (or any other similar service) for Lab00 (Using ChatGPT), Lab01 (HTML/CSS Resume), Lab02 and Lab02a (Web Applications Labs).  **You may NOT use ChatGPT for the SQL Lab (Lab04).**  You are allowed to use ChatGPT for the JDBC Lab (Lab05) and the ORM Lab (Lab06).
